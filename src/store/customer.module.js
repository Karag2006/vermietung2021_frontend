...
export default {
    ...
    state: {
        ...
        form: [
            { fieldname: 'pass_number', label: 'Personalausweis Nr.', type: 'text'},
            ...
            { fieldname: 'car_number', label: 'Kennzeichen vom Zugfahrzeug', type: 'text'},
            { fieldname: 'email', label: 'E-Mail Adresse', type: 'text'},
            { fieldname: 'driving_license_no', label: 'Führerschein Nr.', type: 'text'},
            { fieldname: 'driving_license_class', label: 'Führerschein Klasse', type: 'text'},
        ],
    },
    actions: {
